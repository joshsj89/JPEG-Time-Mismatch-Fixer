...
const getNewTimestamp = (originalTimestamp, offset) => {
    ...
    const date = new Date(Number(originalTimestampParts[0]), Number(originalTimestampParts[1]) - 1, Number(originalTimestampParts[2]), Number(originalTimestampParts[3]), Number(originalTimestampParts[4]), Number(originalTimestampParts[5]));
    ...
    const newDate = new Date(Number(newTimestampParts[0]), Number(newTimestampParts[1]) - 1, Number(newTimestampParts[2]), Number(newTimestampParts[3]), Number(newTimestampParts[4]), Number(newTimestampParts[5]));
    return newDate;
};
